...
#[repr(C)]
struct ClosableNotifierHandlerBox<F: Fn() -> windows_core::Result<()> + Send + 'static> {
    vtable: *const ClosableNotifierHandler_Vtbl,
    invoke: F,
    count: windows_core::imp::RefCount,
}
impl<F: Fn() -> windows_core::Result<()> + Send + 'static> ClosableNotifierHandlerBox<F> {
...
pub trait IClosableNotifier_Impl: windows_core::IUnknownImpl {
    ...
    fn Closed(
        &self,
        handler: windows_core::Ref<ClosableNotifierHandler>,
