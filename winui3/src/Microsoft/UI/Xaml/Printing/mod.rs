...
impl AddPagesEventHandler {
    pub fn new<
        F: Fn(
                ...
                windows_core::Ref<AddPagesEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
impl GetPreviewPageEventHandler {
    pub fn new<
        F: Fn(
                windows_core::Ref<windows_core::IInspectable>,
                windows_core::Ref<GetPreviewPageEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
pub trait IPrintDocument_Impl: windows_core::IUnknownImpl {
    ...
    fn Paginate(
        &self,
        handler: windows_core::Ref<PaginateEventHandler>,
    ) -> windows_core::Result<i64>;
    fn RemovePaginate(&self, token: i64) -> windows_core::Result<()>;
    fn GetPreviewPage(
        &self,
        handler: windows_core::Ref<GetPreviewPageEventHandler>,
    ) -> windows_core::Result<i64>;
    fn RemoveGetPreviewPage(&self, token: i64) -> windows_core::Result<()>;
    fn AddPages(
        &self,
        handler: windows_core::Ref<AddPagesEventHandler>,
    ) -> windows_core::Result<i64>;
    fn RemoveAddPages(&self, token: i64) -> windows_core::Result<()>;
    fn AddPage(&self, pageVisual: windows_core::Ref<super::UIElement>) -> windows_core::Result<()>;
    ...
    fn SetPreviewPage(
        &self,
        pageNumber: i32,
        pageVisual: windows_core::Ref<super::UIElement>,
    ) -> windows_core::Result<()>;
...
impl PaginateEventHandler {
    pub fn new<
        F: Fn(
                windows_core::Ref<windows_core::IInspectable>,
                windows_core::Ref<PaginateEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
