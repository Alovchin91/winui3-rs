...
impl CurrentChangingEventHandler {
    pub fn new<
        F: Fn(
                ...
                windows_core::Ref<CurrentChangingEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
pub trait IBinding_Impl: windows_core::IUnknownImpl {
    ...
    fn SetPath(&self, value: windows_core::Ref<super::PropertyPath>) -> windows_core::Result<()>;
    ...
    fn SetRelativeSource(
        &self,
        value: windows_core::Ref<RelativeSource>,
    ) -> windows_core::Result<()>;
    ...
    fn SetConverter(&self, value: windows_core::Ref<IValueConverter>) -> windows_core::Result<()>;
...
pub trait IBindingOperationsStatics_Impl: windows_core::IUnknownImpl {
    fn SetBinding(
        &self,
        target: windows_core::Ref<super::DependencyObject>,
        dp: windows_core::Ref<super::DependencyProperty>,
        binding: windows_core::Ref<BindingBase>,
    ) -> windows_core::Result<()>;
}
    ...
    + windows_collections::IVector_Impl<windows_core::IInspectable>
{
    ...
    fn CurrentChanging(
        &self,
        handler: windows_core::Ref<CurrentChangingEventHandler>,
    ) -> windows_core::Result<i64>;
...
pub trait ICollectionViewSource_Impl: windows_core::IUnknownImpl {
    ...
    fn SetItemsPath(
        &self,
        value: windows_core::Ref<super::PropertyPath>,
    ) -> windows_core::Result<()>;
}
...
pub trait ICustomProperty_Impl: windows_core::IUnknownImpl {
    ...
    fn GetIndexedValue(
        &self,
        target: windows_core::Ref<windows_core::IInspectable>,
        index: windows_core::Ref<windows_core::IInspectable>,
    ) -> windows_core::Result<windows_core::IInspectable>;
    fn SetIndexedValue(
        &self,
        target: windows_core::Ref<windows_core::IInspectable>,
...
pub trait IItemsRangeInfo_Impl: windows::Foundation::IClosable_Impl {
    fn RangesChanged(
        &self,
        visibleRange: windows_core::Ref<ItemIndexRange>,
        trackedItems: windows_core::Ref<windows_collections::IVectorView<ItemIndexRange>>,
    ) -> windows_core::Result<()>;
}
...
pub trait INotifyDataErrorInfo_Impl: windows_core::IUnknownImpl {
    ...
    fn ErrorsChanged(
        &self,
        handler: windows_core::Ref<windows::Foundation::EventHandler<DataErrorsChangedEventArgs>>,
    ) -> windows_core::Result<i64>;
...
pub trait INotifyPropertyChanged_Impl: windows_core::IUnknownImpl {
    fn PropertyChanged(
        &self,
        handler: windows_core::Ref<PropertyChangedEventHandler>,
    ) -> windows_core::Result<i64>;
...
pub trait ISelectionInfo_Impl: windows_core::IUnknownImpl {
    fn SelectRange(
        &self,
        itemIndexRange: windows_core::Ref<ItemIndexRange>,
    ) -> windows_core::Result<()>;
    fn DeselectRange(
        &self,
        itemIndexRange: windows_core::Ref<ItemIndexRange>,
...
impl PropertyChangedEventHandler {
    pub fn new<
        F: Fn(
                windows_core::Ref<windows_core::IInspectable>,
                windows_core::Ref<PropertyChangedEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
