...
pub trait IFrameNavigationOptions_Impl: windows_core::IUnknownImpl {
    ...
    fn SetTransitionInfoOverride(
        &self,
        value: windows_core::Ref<super::Media::Animation::NavigationTransitionInfo>,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "UI_Xaml_Media_Animation")]
...
impl NavigatedEventHandler {
    pub fn new<
        F: Fn(
                ...
                windows_core::Ref<NavigationEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
impl NavigatingCancelEventHandler {
    pub fn new<
        F: Fn(
                windows_core::Ref<windows_core::IInspectable>,
                windows_core::Ref<NavigatingCancelEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
impl NavigationFailedEventHandler {
    pub fn new<
        F: Fn(
                windows_core::Ref<windows_core::IInspectable>,
                windows_core::Ref<NavigationFailedEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
