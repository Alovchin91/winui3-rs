...
impl DownloadProgressEventHandler {
    pub fn new<
        F: Fn(
                ...
                windows_core::Ref<DownloadProgressEventArgs>,
            ) -> windows_core::Result<()>
            + Send
            + 'static,
    >(
...
pub trait IBitmapImage_Impl: windows_core::IUnknownImpl {
    ...
    fn DownloadProgress(
        &self,
        handler: windows_core::Ref<DownloadProgressEventHandler>,
    ) -> windows_core::Result<i64>;
    ...
    fn ImageFailed(
        &self,
        handler: windows_core::Ref<super::super::ExceptionRoutedEventHandler>,
    ) -> windows_core::Result<i64>;
...
pub trait IBitmapImageFactory_Impl: windows_core::IUnknownImpl {
    fn CreateInstanceWithUriSource(
        &self,
        uriSource: windows_core::Ref<windows::Foundation::Uri>,
...
pub trait IBitmapSource_Impl: windows_core::IUnknownImpl {
    ...
    fn SetSource(
        &self,
        streamSource: windows_core::Ref<windows::Storage::Streams::IRandomAccessStream>,
    ) -> windows_core::Result<()>;
    fn SetSourceAsync(
        &self,
        streamSource: windows_core::Ref<windows::Storage::Streams::IRandomAccessStream>,
...
pub trait IRenderTargetBitmap_Impl: windows_core::IUnknownImpl {
    ...
    fn RenderAsync(
        &self,
        element: windows_core::Ref<super::super::UIElement>,
    ) -> windows_core::Result<windows_future::IAsyncAction>;
...
pub trait ISoftwareBitmapSource_Impl: windows_core::IUnknownImpl {
    fn SetBitmapAsync(
        &self,
        softwareBitmap: windows_core::Ref<windows::Graphics::Imaging::SoftwareBitmap>,
    ) -> windows_core::Result<windows_future::IAsyncAction>;
}
