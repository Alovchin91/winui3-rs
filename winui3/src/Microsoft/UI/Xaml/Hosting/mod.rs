...
pub trait IDesktopWindowXamlSource_Impl: windows_core::IUnknownImpl {
    ...
    fn SetContent(&self, value: windows_core::Ref<super::UIElement>) -> windows_core::Result<()>;
    ...
    fn SetSystemBackdrop(
        &self,
        value: windows_core::Ref<super::Media::SystemBackdrop>,
    ) -> windows_core::Result<()>;
    ...
    fn NavigateFocus(
        &self,
        request: windows_core::Ref<XamlSourceFocusNavigationRequest>,
    ) -> windows_core::Result<XamlSourceFocusNavigationResult>;
...
pub trait IElementCompositionPreviewStatics_Impl: windows_core::IUnknownImpl {
    ...
    fn SetElementChildVisual(
        &self,
        element: windows_core::Ref<super::UIElement>,
        visual: windows_core::Ref<super::super::Composition::Visual>,
    ) -> windows_core::Result<()>;
    fn GetScrollViewerManipulationPropertySet(
        &self,
        scrollViewer: windows_core::Ref<super::Controls::ScrollViewer>,
    ) -> windows_core::Result<super::super::Composition::CompositionPropertySet>;
    fn SetImplicitShowAnimation(
        &self,
        element: windows_core::Ref<super::UIElement>,
        animation: windows_core::Ref<super::super::Composition::ICompositionAnimationBase>,
    ) -> windows_core::Result<()>;
    ...
    fn GetPointerPositionPropertySet(
        &self,
        targetElement: windows_core::Ref<super::UIElement>,
    ) -> windows_core::Result<super::super::Composition::CompositionPropertySet>;
}
#[cfg(all(feature = "UI_Composition", feature = "UI_Xaml_Controls"))]
