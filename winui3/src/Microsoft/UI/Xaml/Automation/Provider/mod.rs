...
pub trait IItemContainerProvider_Impl: windows_core::IUnknownImpl {
    fn FindItemByProperty(
        &self,
        startAfter: windows_core::Ref<IRawElementProviderSimple>,
        automationProperty: windows_core::Ref<super::AutomationProperty>,
...
pub trait ITextRangeProvider_Impl: windows_core::IUnknownImpl {
    ...
    fn Compare(
        &self,
        textRangeProvider: windows_core::Ref<ITextRangeProvider>,
