...
pub trait ICompositionDebugHeatMaps_Impl: windows_core::IUnknownImpl {
    fn Hide(&self, subtree: windows_core::Ref<super::Visual>) -> windows_core::Result<()>;
    fn ShowMemoryUsage(
        &self,
        subtree: windows_core::Ref<super::Visual>,
    ) -> windows_core::Result<()>;
    fn ShowOverdraw(
        &self,
        subtree: windows_core::Ref<super::Visual>,
    ...
    fn ShowRedraw(&self, subtree: windows_core::Ref<super::Visual>) -> windows_core::Result<()>;
}
