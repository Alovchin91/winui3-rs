...
pub trait ICompositionConditionalValue_Impl: windows_core::IUnknownImpl {
    ...
    fn SetCondition(
        &self,
        value: windows_core::Ref<super::ExpressionAnimation>,
    ) -> windows_core::Result<()>;
...
pub trait ICompositionConditionalValueStatics_Impl: windows_core::IUnknownImpl {
    fn Create(
        &self,
        compositor: windows_core::Ref<super::Compositor>,
...
pub trait ICompositionInteractionSourceCollection_Impl: windows_core::IUnknownImpl {
    ...
    fn Add(
        &self,
        value: windows_core::Ref<ICompositionInteractionSource>,
    ) -> windows_core::Result<()>;
    fn Remove(
        &self,
        value: windows_core::Ref<ICompositionInteractionSource>,
...
pub trait IInteractionTracker_Impl: windows_core::IUnknownImpl {
    ...
    fn SetPositionInertiaDecayRate(
        &self,
        value: windows_core::Ref<windows::Foundation::IReference<windows_numerics::Vector3>>,
    ) -> windows_core::Result<()>;
    ...
    fn SetScaleInertiaDecayRate(
        &self,
        value: windows_core::Ref<windows::Foundation::IReference<f32>>,
    ) -> windows_core::Result<()>;
    ...
    fn TryUpdatePositionWithAnimation(
        &self,
        animation: windows_core::Ref<super::CompositionAnimation>,
...
pub trait IInteractionTrackerInertiaNaturalMotion_Impl: windows_core::IUnknownImpl {
    ...
    fn SetNaturalMotion(
        &self,
        value: windows_core::Ref<super::ScalarNaturalMotionAnimation>,
    ) -> windows_core::Result<()>;
}
...
pub trait IInteractionTrackerStatics_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateWithOwner(
        &self,
        compositor: windows_core::Ref<super::Compositor>,
        owner: windows_core::Ref<IInteractionTrackerOwner>,
    ) -> windows_core::Result<InteractionTracker>;
}
...
pub trait IInteractionTrackerStatics2_Impl: windows_core::IUnknownImpl {
    fn SetBindingMode(
        &self,
        boundTracker1: windows_core::Ref<InteractionTracker>,
        boundTracker2: windows_core::Ref<InteractionTracker>,
...
pub trait IInteractionTrackerVector2InertiaNaturalMotion_Impl: windows_core::IUnknownImpl {
    ...
    fn SetNaturalMotion(
        &self,
        value: windows_core::Ref<super::Vector2NaturalMotionAnimation>,
    ) -> windows_core::Result<()>;
}
...
pub trait IVisualInteractionSource_Impl: windows_core::IUnknownImpl {
    ...
    fn TryRedirectForManipulation(
        &self,
        pointerPoint: windows_core::Ref<super::super::Input::PointerPoint>,
    ) -> windows_core::Result<()>;
}
#[cfg(feature = "UI_Input")]
...
pub trait IVisualInteractionSourceStatics_Impl: windows_core::IUnknownImpl {
    fn Create(
        &self,
        source: windows_core::Ref<super::Visual>,
...
pub trait IVisualInteractionSourceStatics2_Impl: windows_core::IUnknownImpl {
    fn CreateFromIVisualElement(
        &self,
        source: windows_core::Ref<super::IVisualElement>,
    ) -> windows_core::Result<VisualInteractionSource>;
}
