...
pub trait IDragDropManagerStatics_Impl: windows_core::IUnknownImpl {
    fn GetForIsland(
        &self,
        content: windows_core::Ref<super::super::Content::ContentIsland>,
...
pub trait IDragOperation_Impl: windows_core::IUnknownImpl {
    ...
    fn SetDragUIContentFromSoftwareBitmap(
        &self,
        bitmap: windows_core::Ref<windows::Graphics::Imaging::SoftwareBitmap>,
    ) -> windows_core::Result<()>;
    ...
    fn StartAsync(
        &self,
        initialTarget: windows_core::Ref<DragDropManager>,
        initialPointerPoint: windows_core::Ref<super::PointerPoint>,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<
            windows::ApplicationModel::DataTransfer::DataPackageOperation,
        >,
...
pub trait IDropOperationTarget_Impl: windows_core::IUnknownImpl {
    fn DropAsync(
        &self,
        dragInfo: windows_core::Ref<DragInfo>,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<
            windows::ApplicationModel::DataTransfer::DataPackageOperation,
        >,
    ...
    fn EnterAsync(
        &self,
        dragInfo: windows_core::Ref<DragInfo>,
        dragUIOverride: windows_core::Ref<DragUIOverride>,
    ) -> windows_core::Result<
        windows_future::IAsyncOperation<
            windows::ApplicationModel::DataTransfer::DataPackageOperation,
        >,
...
pub trait IDropOperationTargetRequestedEventArgs_Impl: windows_core::IUnknownImpl {
    fn SetTarget(
        &self,
        target: windows_core::Ref<IDropOperationTarget>,
    ) -> windows_core::Result<()>;
}
